...
for output in outputs:
    ...
    if keyName == "oLambdaURL":
        endpoint = output["OutputValue"]

method = 'GET'
service = 'lambda'
host = endpoint[8:-1] # endpoint without https:// and not "/" at the end
region = 'us-east-1'
request_parameters = 'deviceID=123456'
...
try:
    ...
    session_token_exist = True
except:
    session_token_exist = False
