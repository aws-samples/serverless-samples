...
). To verify it run command basename "pwd" - it should return serverless-samples as an output.
...
You can find url to AWS CodeCommit Repository in output section of CloudFormaion stack deployed above.
