...
class ApiPipelineStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        integration_stage = AppStage(self, 'cdk-pipeline-int-test', cognito_stack_name='Cognito')
        ...
        deployment_stage = AppStage(self, 'cdk-pipeline-deployment', cognito_stack_name='Cognito')
