# python-appsync-sam
This is implementation of the backend GraphQL API using Python and AWS SAM. SAM had been chosen for future extensibility and ease of development of Serverless resources, such as Lambda Resolvers or Lambda Authorizers. 
...
```bash
sam build
sam deploy --guided --stack-name python-appsync-sam
```
