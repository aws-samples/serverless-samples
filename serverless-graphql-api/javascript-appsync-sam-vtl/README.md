...
***Note:** Before deploying application first time manually, you will need to deploy shared Cognito stack, see the previous section for the details.*
