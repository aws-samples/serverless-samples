...
const mappingsBasePath = "./src/mapping_templates/";
...
function getEvaluationResponse(templateFileName, context) {
    return appSyncClient.send(
        new AWS.EvaluateMappingTemplateCommand({
            template: fs.readFileSync(mappingsBasePath + templateFileName, 'utf8'),
...
describe('Test AppSync resolvers', () => {
    ...
    it('location create resolver with location id passed as a parameter', async () => {
        ...
        response = await getEvaluationResponse('create_location_request.vtl', context);
        ...
        response = await getEvaluationResponse('create_location_response.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
    ...
    it('location delete resolver', async () => {
        ...
        //Test request mapping template
        response = await getEvaluationResponse('delete_location_request.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        expect(evaluationResult.operation).toBe("DeleteItem");
        expect(evaluationResult.key.locationid.S).toBe(context.arguments.locationid);

        //Test response mapping template
        response = await getEvaluationResponse('delete_location_response.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
    ...
    it('get single location resolver', async () => {
        ...
        //Test request mapping template
        response = await getEvaluationResponse('get_location_request.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        expect(evaluationResult.operation).toBe("GetItem");
        expect(evaluationResult.key.locationid.S).toBe(context.arguments.locationid);

        //Test response mapping template
        response = await getEvaluationResponse('get_location_response.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        // Check that all result fields are present in the response after transformation
        for (const [key, value] of Object.entries(evaluationResult)) {
            expect(evaluationResult[key]).toBe(context.result[key]);
    ...
    it('get all locations resolver', async () => {
        ...
        //Test request mapping template
        response = await getEvaluationResponse('get_locations_request.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        expect(evaluationResult.operation).toBe("Scan");

        //Test response mapping template
        response = await getEvaluationResponse('get_locations_response.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
    ...
    it('create resource resolver with resource id passed as a parameter ', async () => {
        ...
        //Test request mapping template
        response = await getEvaluationResponse('create_resource_request.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        expect(evaluationResult.operation).toBe("PutItem");
        ...
        //Test response mapping template
        response = await getEvaluationResponse('create_resource_response.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        // Check that all result fields are present in the response after transformation
        for (const [key, value] of Object.entries(evaluationResult)) {
            expect(evaluationResult[key]).toBe(context.result[key]);
    ...
    it('delete resource resolver', async () => {
        ...
        //Test request mapping template
        response = await getEvaluationResponse('delete_resource_request.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        expect(evaluationResult.operation).toBe("DeleteItem");
        expect(evaluationResult.key.resourceid.S).toBe(context.arguments.resourceid);

        //Test response mapping template
        response = await getEvaluationResponse('delete_resource_response.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
    ...
    it('get single resource resolver', async () => {
        ...
        //Test request mapping template
        response = await getEvaluationResponse('get_resource_request.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        expect(evaluationResult.operation).toBe("GetItem");
        expect(evaluationResult.key.resourceid.S).toBe(context.arguments.resourceid);

        //Test response mapping template
        response = await getEvaluationResponse('get_resource_response.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        // Check that all result fields are present in the response after transformation
        for (const [key, value] of Object.entries(evaluationResult)) {
            expect(evaluationResult[key]).toBe(context.result[key]);
    ...
    it('get resources for location resolver ', async () => {
        ...
        //Test request mapping template
        response = await getEvaluationResponse('get_resources_for_location_request.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        ...
        //Test response mapping template
        response = await getEvaluationResponse('get_resources_for_location_response.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        expect(evaluationResult.length).toBe(Object.keys(context.result.items).length);
        // Check that all items in the results list are present in the response after transformation
        for (i = 0; i < evaluationResult.length; i++) {
    ...
    it('create booking resolver with booking id passed as a parameter', async () => {
        ...
        //Test request mapping template
        response = await getEvaluationResponse('create_booking_request.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        expect(evaluationResult.operation).toBe("PutItem");
        ...
        //Test response mapping template
        response = await getEvaluationResponse('create_booking_response.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        // Check that all result fields are present in the response after transformation
        for (const [key, value] of Object.entries(evaluationResult)) {
            expect(evaluationResult[key]).toBe(context.result[key]);
    ...
    it('get single booking resolver', async () => {
        ...
        //Test request mapping template
        response = await getEvaluationResponse('get_booking_request.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        expect(evaluationResult.operation).toBe("GetItem");
        expect(evaluationResult.key.bookingid.S).toBe(context.arguments.bookingid);

        //Test response mapping template
        response = await getEvaluationResponse('get_booking_response.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        // Check that all result fields are present in the response after transformation
        for (const [key, value] of Object.entries(evaluationResult)) {
            expect(evaluationResult[key]).toBe(context.result[key]);
    ...
    it('get bookings for resource resolver ', async () => {
        ...
        //Test request mapping template
        response = await getEvaluationResponse('get_bookings_for_resource_request.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        expect(evaluationResult.operation).toBe("Query");
        ...
        //Test response mapping template
        response = await getEvaluationResponse('get_bookings_for_resource_response.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        // Check that all items in the results list are present in the response after transformation
        for (i = 0; i < evaluationResult.length; i++) {
            // Check that all result fields are present in the response after transformation
    ...
    it('get bookings for user resolver ', async () => {
        ...
        //Test request mapping template
        response = await getEvaluationResponse('get_bookings_for_user_request.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        expect(evaluationResult.operation).toBe("Query");
        ...
        //Test response mapping template
        response = await getEvaluationResponse('get_bookings_for_user_response.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        // Check that all items in the results list are present in the response after transformation
        for (i = 0; i < evaluationResult.length; i++) {
            // Check that all result fields are present in the response after transformation
    ...
    it('delete booking resolver', async () => {
        ...
        //Test request code
        response = await getEvaluationResponse('delete_booking_request.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
        expect(evaluationResult.operation).toBe("DeleteItem");
        expect(evaluationResult.key.bookingid.S).toBe(context.arguments.bookingid);
        ...
        //Test response code
        response = await getEvaluationResponse('delete_booking_response.vtl', context);
        evaluationResult = JSON.parse(response.evaluationResult);
